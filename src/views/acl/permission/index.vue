...
const menuParams = ref<addOrUpdateMenuParam>({ // 收集添加或更新菜单参数
  // name: '',
  // code: '',
})
const form = ref()
...
async function getAllMenuList() { // 获取所有的菜单列表
...
async function onDelMenu(row: menuObj) { // 删除菜单
